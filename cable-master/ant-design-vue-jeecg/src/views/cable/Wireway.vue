      ...
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="24">
            ...
            style="width: 400px;margin-right: -140px">
          ...
          <a-col :md="6" :sm="24">
              <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
                <a-button type="primary" @click="searchQuery" icon="search">查询</a-button>
                 <a-button style="margin-left: 8px" type="primary" icon="import"
                           @click="showExportModal">导出反馈汇总</a-button>
           ...
           <a-form>
                ...
                <template slot="footer">
                  <a-button type="primary" @click="handleExportXls2('线路统计汇总')">导出统计</a-button>
