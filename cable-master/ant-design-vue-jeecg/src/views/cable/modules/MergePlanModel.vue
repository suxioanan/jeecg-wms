    ...
    <a-spin :spinning="confirmLoading" style="margin-top: 10px">
      <a-form
        ...
        <a-row :gutter="24">
          ...
          <a-col :span="12">
            <a-button @click="queryCler" type="primary" style="width: 100px;float:right;margin-right: 230px;">
              清空
            </a-button>
            <a-button @click="handleOk" type="primary" style="width: 100px;float: right;margin-right: 30px">
          ...
          <div style="margin-top: 10px;">
            ...
            <div style="display: inline-block;width: 100%;">
              <a-table
                ...
                <span slot="factoryText15" slot-scope="text">
                  <j-ellipsis :value="text" :length="15"/>
                </span>
                <span slot="realname" slot-scope="text">
                  <j-ellipsis :value="text" :length="10"/>
                </span>
                <span slot="sendNumber" slot-scope="text, record">
                   <a-input-number
                    placeholder="数量"
                    :max-length="4"
                    style="width: 80%"
                    @change="onChange"
                    @blur="sendNumberonblur"
                  />
                </span>
...
<script>
  ...
  export default {
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            scopedSlots: { customRender: 'factoryText15' },
          ...
          },
          {
            ...
            align: 'center',
            width: 100,
            scopedSlots: { customRender: 'sendNumber' }
          }
        ],
    ...
    methods: {
      ...
      sendNumberonblur(val){
        console.log("进入了sendNumberonblur方法！！！！！！")
        console.log("sendNumberonblur>>>>:",val)
      },
      /**
       * 派单类型 change 方法[待定功能]============
