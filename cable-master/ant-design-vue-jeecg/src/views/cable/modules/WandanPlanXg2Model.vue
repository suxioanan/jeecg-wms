    ...
    data() {
      return {
        ...
        url: {
          ...
          getPlan1ReceivingStorageList: '/cable/plan2/getPlan2ReceivingStorageList',
          getPlan1DeliverStorage: '/cable/plan2/getPlan2DeliverStorage'
        }
      }
    },
    methods: {
      ...
      wandanplanmodelShow(record) {
        ...
        console.log("that.wdrecord 数据回显  >> : ",that.wdrecord)
        ...
        console.log('进入了合并完单页面 数据回显 >>>', record)
        this.activeKey = '1'
      ...
      requestTableData(url, params, tab) {
        ...
        getAction(url, params).then(res => {
          ...
          console.log("数据回显》》》：",this.defaultTable.dataSource[0])
          })
      ...
      requestAddOrEdit(formData) {
        ...
        console.log('this 数据 数据回显 warehouseId >>:',this.WarehouseId)
        console.log('this 数据 数据回显 storageLocationId >>:',this.storageLocationId)
        console.log('this 数据 数据回显 EndWarehouseId >>:',this.EndWarehouseId)
        console.log('this 数据 数据回显 unit >>:',this.unit)
        console.log('集合内新参数 数据回显 >>:',formData.completeOrderList[0])
