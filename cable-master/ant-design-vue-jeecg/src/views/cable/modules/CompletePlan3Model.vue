        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="交接单号">
              <a-input v-decorator="['plan3ReceiptNo']" placeholder="请输入交接单号"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: '/cable/plan3/consolidationCompleted',
          getPlan3ReceivingStorageList: '/cable/plan3/getPlan3ReceivingStorageList',
          getPlan3DeliverStorage: '/cable/plan3/getPlan3DeliverStorage'
        }
      }
    },
    methods: {
      ...
      completePlanModelShow (record) {
        ...
        if (record) {
          ...
          this.requestTableData(this.url.getPlan3ReceivingStorageList, this.plan3Ids, this.table1)
